...
public class MethodsReturnWith_WaterTax {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(waterTax(scan.nextDouble()));
    }
}

    /*
    The waterTax method calculates a water bill.
    The method takes a double and returns a double.
