...
/*
Task3:
	1. create method that accepts one integer array and one integer number
	...
	2. create method that accepts one double array and one double number
	and returns the frequency of the number


	3. create method that accepts one String array and one String and
	...
	4. create method that accepts one char array and a char and
