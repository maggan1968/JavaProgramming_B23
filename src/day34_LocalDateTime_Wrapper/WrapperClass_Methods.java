...
public class WrapperClass_Methods {
  public static void main(String[] args) {
    ...
    // converting String to the int primitives
    String str = "123";
    ...
    /*
    parse/valueOf methods you will only use it when you need to convert
    from string to other primitive/wrapper. type. to convert from short
     to byte you do not need any method. you need explicit casting
     */
