...
//sort() method: sorts the elements of the array in ascending(rosnacy) order

        String[] students = {"margie", "Anna", "Tunba", " Bob"};
        System.out.println(Arrays.toString(students));

        Arrays.sort(students);//  the array is sorted ascending order (a to z)
        System.out.println(Arrays.toString(students));
