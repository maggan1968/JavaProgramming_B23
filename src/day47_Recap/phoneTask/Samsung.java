...
public final class Samsung extends Phone {
    ...
    public Samsung(String model, String size, String color, double price) {
        super("Samsung", model, size, color, price);// calling  parent class method
    }
    ...
    public void text(long phone1, long phone2) {//overloading
        text(phone1);
        text(phone2);
    }

    public void text(long phone1, long phone2, long phone3) {//overloading
        text(phone1, phone2);
        text(phone3);

    }

    public void text(long phone1, long phone2, long phone3, long phone4) {//overloading
