...
public class Massage_Replit {
    public static void main(String[] args) {
        ...
        String phoneNumber = message.substring((message.indexOf("[")+1),
                (message.indexOf("]")));
...
From Number:[202-123-3456].
 Message:{I love programing and problem solving} assign the value of the
  sender,
